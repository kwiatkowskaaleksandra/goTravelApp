...
<section id="content">
    ...
    "sig": "a312b9c3cb4a1b693e8ebac5ee1ca9cc01f2661c14391917dcb111517f72370809..."
        ...
        <p>The <code>sig</code> is generated using the following template: <code>${package.name}@${package.version}:${
            package.dist.integrity}</code> and the <code>keyid</code> has to match one of the public signing keys below.
        </p>
        <ol start="2">
    ...
    "key": "{{B64_PUBLIC_KEY}}"
        ...
        <p>Keys response:</p>
        <ul>
            <li><code>expires</code>: null or a simplified extended ISO 8601 format:
