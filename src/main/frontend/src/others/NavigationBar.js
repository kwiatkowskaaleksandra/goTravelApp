        ...
        <Navbar bg="white" expand="lg" className="navbar-visible">
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="ml-auto">
                    ...
                    <NavDropdown title="OFERTA" id="basic-nav-dropdown" className={"custom-dropdown-menu"}
                                 aria-expanded="true">
                        <Row>
                            <Col>
                                <center><NavDropdown.Item className="dropdown-item">
                                    <Nav.Link as={Link} to={"/exotics"} style={{color: 'black'}}> <img alt=""
                                                                                                       src={exotic}
                                                                                                       width="80"
                                                                                                       height="80"
                    ...
                    <Nav.Link as={Link} to={"/"} style={logoutMenuStyle()} onClick={logout}
                              className={"btn btn-primary btn-sm float-right logout-navbar"}>Wyloguj się</Nav.Link>
