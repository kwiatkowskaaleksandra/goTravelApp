...
class Promotion extends Component {
    ...
    handleGetTrips = () => {
        orderApi.getTrips('promocje').then(res => {
    ...
    handleSubmit = () => {
        orderApi.getTripsByFilters('promocje', this.state.selectedCountryId, this.state.selectedTransportId, this.state.priceMin, this.state.priceMax, this.state.numberOfDaysMin, this.state.numberOfDaysMax).then(res => {
            this.setState({trips: res.data})
        })
    }
