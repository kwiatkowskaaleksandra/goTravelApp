...
class Cruise extends Component{
    ...
    handleGetTrips = () => {
        orderApi.getTrips('rejs').then(res => {
    ...
    handleSubmit = () => {
        orderApi.getTripsByFilters('rejs', this.state.selectedCountryId, this.state.selectedTransportId, this.state.priceMin, this.state.priceMax, this.state.numberOfDaysMin, this.state.numberOfDaysMax).then(res => {
            this.setState({trips: res.data})
        })
    }
                                                            ...
                                                            <div className="col">
                                                                ...
                                                                <Card.Body>
                                                                    ...
                                                                    <Card.Link
                                                                        ...
                                                                        href={"cruises/"+trip.idTrip}>Zobacz ofertę</Card.Link>
                                                                </Card.Body>
