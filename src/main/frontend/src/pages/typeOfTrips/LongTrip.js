...
class LongTrip extends Component {
    state = {
        trips: [],
        photos: [],
        transports: [],
    ...
    handleGetTrips = () => {
        orderApi.getTrips('dlugiPobyt').then(res => {
    ...
    handleSubmit = () => {
        orderApi.getTripsByFilters('dlugiPobyt', this.state.selectedCountryId, this.state.selectedTransportId, this.state.priceMin, this.state.priceMax, this.state.numberOfDaysMin, this.state.numberOfDaysMax).then(res => {
            this.setState({trips: res.data})
        })
    }
    ...
    handleClear = () => {
        ...
        window.location.href = "/longTrips"
    }
                        ...
                        <div className="d-flex justify-content-around w-100 ">
                            ...
                            <div className="p-2 w-25 ">
                                ...
                                <div className="input-group mb-3">
                                    ...
                                    <input type="number" className="form-control" min={"0"} aria-label="Cena od"
                                           placeholder="0"
                                           name={"numberOfDaysMin"} onChange={this.handleChangeNumberOfDaysMin}/>
                                    <span className="input-group-text" style={{width: '3rem'}}>Do:</span>
                                    <input type="number" className="form-control" min={"0"} aria-label="Cena do"
                                           placeholder="0"
                                                            ...
                                                            <div className="col">
                                                                <div className="p-3">
                                                                    ...
                                                                    <Card.Body>
                                                                        <Card.Title className={"titleTrip"}>
                                                                            {trip.tripCity.nameCity}, {trip.tripCity.country.nameCountry}
                                                                        </Card.Title>
                                                                    </Card.Body>
                                                                    ...
                                                                    <ListGroup className="list-group-flush listTrip">
                                                                        <ListGroup.Item> <BsCalendarWeek style={{
                                                                            ...
                                                                            height: '15px',
                                                                            marginLeft: '5px'
                                                                        }}/> {trip.numberOfDays} noclegów</ListGroup.Item>

                                                                        <ListGroup.Item> <MdOutlineFoodBank style={{
                                                                            width: '25px',
                                                                            height: '25px'
                                                                        }}/> {trip.food}</ListGroup.Item>

                                                                        <ListGroup.Item> <FaRegPaperPlane style={{
                                                                            width: '15px',
                                                                            height: '15px',
                                                                            marginLeft: '2px'
                                                                        }}/> transport: {trip.tripTransport.nameTransport}
                                                                        </ListGroup.Item>
                                                                    </ListGroup></div>
                                                                ...
                                                                <Card.Body>
                                                                    ...
                                                                    <Card.Link
                                                                        ...
                                                                        href={"longTrips/" + trip.idTrip}>Zobacz
                                                                        ofertę</Card.Link>
                                                                </Card.Body>
